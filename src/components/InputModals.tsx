...
export default function InputModals() {
  return (
    <div className="absolute shadow-md bg-popover rounded-3xl top-16 left-0 border py-8 px-6 min-w-[428px]">
      {" "}
      <h4 className="ml-2 mb-4 text-sm font-medium">Search by region</h4>
      <div className="grid grid-cols-3 grid-rows-2">
        {country.map((el) => (
          <div key={el.id} className="p-2 rounded-2xl hover:bg-inputModals">
