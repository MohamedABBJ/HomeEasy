export default function Inputs({ type, children, activeModals, name }) {
  const style = {
    ...
    big: "px-8 py-3.5 cursor-pointer min-w-[284px] relative hover:before:opacity-100 hover:after:opacity-0 before:content-[''] before:absolute before:top-0 before:-z-10 before:left-0 before:w-full before:h-full before:rounded-full before:bg-zinc-100 before:opacity-0 after:content-[''] after:absolute after:top-1/2 after:right-0 after:w-[1px] after:h-2/4 after:bg-zinc-200 after:-translate-y-1/2",
    small:
    ...
    bigNoBorder:
      "px-8 py-3.5 cursor-pointer relative min-w-[284px] hover:before:opacity-100 hover:after:opacity-0 before:content-[''] before:absolute before:top-0 before:-z-10 before:left-0 before:w-full before:h-full before:rounded-full before:bg-zinc-100 before:opacity-0",
  };
